...
<div class="container d-flex justify-content-center">
    <div class="card shadow p-4 w-100" style="max-width: 700px;">
        ...
        <form action="{{ route('permisos.update', $permiso) }}" method="POST">
            ...
            {{-- Empleado (no modificable) --}}
            <div class="mb-3">
                <label class="form-label">Empleado</label>
                <input type="text" class="form-control" value="{{ $permiso->empleado->user->nombres }} {{ $permiso->empleado->user->apellido_paterno }}" disabled>
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="date" name="fecha_inicio" id="fecha_inicio" class="form-control" value="{{ $permiso->fecha_inicio }}" required>
                </div>
                <div class="col-md-6 mb-3">
                    <label for="fecha_fin" class="form-label">Fecha de Fin</label>
                    <input type="date" name="fecha_fin" id="fecha_fin" class="form-control" value="{{ $permiso->fecha_fin }}" required>
                </div>
            </div>
            ...
            <div class="mb-3">
                ...
                <textarea name="motivo" id="motivo" class="form-control" rows="3" required>{{ $permiso->motivo }}</textarea>
            </div>
            ...
            <div class="mb-3">
                ...
                <textarea name="comentario" id="comentario" class="form-control" rows="2">{{ $permiso->comentario }}</textarea>
            </div>
